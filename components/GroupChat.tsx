    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">💬 Chat du Groupe</h2>
          <p className="text-gray-600 mb-4">Connectez-vous pour participer au chat</p>
          <a
            href="/auth/login"
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
          ...
          <p className="text-gray-600 mt-1">
            Discussions en temps réel avec les membres du groupe
          </p>
        </div>
